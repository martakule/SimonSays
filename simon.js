$(document).ready(function(e) {
	...
	var sequence = [];
	var userSequence = [];
	var c = 0; //Control iterations through the game when answer is correct 
...
//Generate a list of random numbers 0-3 and play them on the colour wheel
	function playSequence() {
		...
		function loop () { //Found this way on the internet to add delay between tiles
